        ...
        <div class="title">
          ...
          <div class="shopping-items">
            ...
            <div v-if="showList" class="shopping-item" v-for="item in cartList" :index="item.id">
              ...
              <div style="width: 640px;display: flex">
                <el-checkbox style="margin: auto"
                             @change="checkboxBox(item.price, item.amount, item.id)"
                             :key="item.id"/>
              ...
              <div class="count">
                <el-input-number v-model="item.amount" size="small"
                                 @change="handleChange(item.amount,item.id, item.price)" :min="1"/>
              </div>
          ...
          <div class="pay">
            ...
            <div style="margin-left: 40px">
              <el-button class="aaaaa" @click="showOrderGo">现在结算
              </el-button>
            </div>
